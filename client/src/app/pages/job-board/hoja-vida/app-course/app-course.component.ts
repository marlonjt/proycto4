...
export class AppCourseComponent implements OnInit {
    ...
    getCourses() {
        ...
        this.jobBoardService.get('courses?limit=9&page=1&field=id&order=ASC&user_id=1').subscribe(
            response => {
                this.spinnerService.hide();
                this.courses = response['courses']['data'][0]['courses'];
            }, error => {
                this.spinnerService.hide();
                this.messageService.add({
                    key: 'tst',
    ...
    createCourse() {
        ...
        this.spinnerService.show();
        this.jobBoardService.post('courses', { 'course': this.selectedCourse }).subscribe(
            response => {
    ...
    deleteCourse(course: Course) {
        this.confirmationService.confirm({
            ...
            accept: () => {
                this.spinnerService.show();
                this.jobBoardService.delete('courses' + course.id).subscribe(
                    response => {
